    ...
    <div class="max-w-4xl mx-auto mt-10">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <div class="flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold text-main-graphit">История заказов</h2>
            ...
            @if($sales->count() > 0)
                <div class="space-y-4">
                    @foreach($sales as $sale)
                        <a href="{{ route('profile.order.show', $sale->id) }}" class="block bg-gray-50 rounded-lg p-5 hover:bg-gray-100 transition border border-gray-200">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="text-gray-600 mb-4 text-lg">У вас пока нет заказов</p>
